...
let dictionary = {
  "english": {
    ...
    "_profile": "Profile: ",
    "_about0": "About me",
    "_about1": "Always in the world of information, across all its aspects. <br />System operations, design, support and maintenance of software and infrastructures. <br />",
    "_about2": "AWS advanced user, expert Linux user (Debian and Slackware).<br />Open Source contributor.<br />Consultant in disaster prevention and incident supervisor.<br />",
    ...
    "_service3": "Application and infrastructure monitoring. Automatic registration of new, scaled targets. Disasters recognition and triggers to start mitigating the damage. Integration with alerting systems to get the right people on the issue.",
    "_member0": "Constant festive fuckwit. System Administrator, with an eye against the past and another against the future. That one who puts his face on ICANN registers and his hands on the keyboard.",
  ...
  "italian": {
    ...
    "_member0": "Il festive fuckwit. Amministratore di sistemi, con un occhio verso la storia e l'altro verso il futuro. Quello che mette la faccia sui registri ICANN e le mani sulla tastiera.",
